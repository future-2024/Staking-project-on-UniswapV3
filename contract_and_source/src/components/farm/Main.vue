                ...
                <div class="vaults">
                    <div class="overview">
                        <div class="d-flex justify-content-between">
                            <div class="align-self-center"><h4 class="text-warning"> {{this.userEarnedAmount}} <small class="text-blue">Your Earnings</small></h4></div>
                            <div class="align-self-center"><h4 class="text-warning"> {{this.userStakedAmount}} <small class="text-pink">Your Staked</small></h4></div>
                            <div class="align-self-center"><h6 class="text-black"> LP Tokens to Stake:</h6></div>
                            <q-select 
                            ...
                            <template v-slot:body="props">
                                <q-tr :props="props" 
                                    ...
                                    <q-td class="text-right">
                                        ...
                                        <div class="btn btn-primary text-white border-white" @click="harvest(props.row.pId, props.row.availableHarvest)" :disabled="props.row.availableHarvest">Harvest</div>
                                    </q-td>
                                    <q-td class="text-right">
                                        <div class="text-gray">Withdraw: <span class="text-red text-bold"> {{ props.row.remainedTimeForWithdraw }} </span> mins remains</div>
                                        <div class="btn btn-success text-white border-white" @click="unstake(props.row.pId, props.row.availableWithdraw)" :disabled="props.row.availableWithdraw">Withdraw</div>
                                    </q-td>
                                </q-tr>                                                                                      
                            </template>
                        </q-table>
            ...
            getDepositInfoPerUser() {
                ...
                if(this.$store.state.account && this.$store.state.farming.perUserInfo) {
                    ...
                    if(this.$store.state.farming.perUserInfo[2].length > 0) {               
                        ...
                        this.userEarnedAmount = BigNumber(this.$store.state.farming.perUserInfo[1]).shiftedBy(-18).toFormat(2);
                        this.userStakedAmount = BigNumber(this.$store.state.farming.perUserInfo[0]).shiftedBy(-18).toFormat(2);
